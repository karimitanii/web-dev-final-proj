...
<html lang="en">
  ...
  <head>
    ...
    <title>Walter White chef contact page</title>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Contact Us</h3>
          <span class="breadcrumb"><a href="indexClient.php">Home</a>  >  Contact Us</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-text">
            ...
            <p>For any questions or inquiries about Chef Walter White, feel free to drop us a message!</p>
            <ul>
              <li><span>Address</span> Sunny Isles Beach, FL 33160, United States</li>
              <li><span>Phone</span> +123 456 7890</li>
              <li><span>Email</span> walterWhite@contact.com</li>
            </ul>
          </div>
        </div>
        <div class="col-lg-6">
              ...
              <div class="col-lg-12">
                <form id="contact-form" action="../BE/controllers/userController.php" method="post">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <button type="submit" id="form-submit" class="orange-button"  onclick="alert('Form Submitted Successfully!')"> Send Message Now</button>
                      </fieldset>
                    </div>
                  </div>
                </form>
